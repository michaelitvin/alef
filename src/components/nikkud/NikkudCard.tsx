...
export type NikkudCardSize = 'sm' | 'md' | 'lg' | 'xl'

export interface NikkudCardProps {
  /** The Hebrew letter to display */
  letter: string
  /** The nikkud (vowel mark) to display */
  nikkud: string
  /** Size of the card */
  size?: NikkudCardSize
...
const sizeConfig: Record<NikkudCardSize, { card: string; font: string }> = {
...
/**
 * NikkudCard - Displays a Hebrew letter with a specific nikkud (vowel mark)
 * Used for nikkud introduction, quizzes, and combination activities
 */
export const NikkudCard = forwardRef<HTMLDivElement, NikkudCardProps>(
  (
    {
      letter,
      nikkud,
    ...
    // Combine letter and nikkud
    const displayText = `${letter}${nikkud}`
    ...
    return (
      <motion.div
        ...
        aria-label={`אות ${letter} עם ניקוד`}
...
NikkudCard.displayName = 'NikkudCard'

export default NikkudCard
